						...
						<div
							...
							<template v-for="section in this.sections.data" :key="section.id">
								<div
									...
									<button type="button"
													class="active:text-blue-600 flex items-center w-full text-black hover:text-gray-300 font-medium dark:text-gray-200 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
										{{ section.title }}
							...
							<Link :href="route('client.schedule')" class="hover:opacity-70 py-3">
								<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
										 stroke="currentColor" class="w-6 h-6 text-black md:block hidden">
									<path stroke-linecap="round" stroke-linejoin="round"
