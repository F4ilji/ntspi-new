<template>
	<AdminLayout>
		<AdminFormLayout>
			<AdminFormHeader :title="'Добавить пользователя'" />
...
export default {
    ...
    data() {
        return {
			formDetailInfo: this.$inertia.form({
				...
				educatorPosition: null,
				education: null,
				awards: null,
				professDisciplines: null,
				professionalRetraining: null,
				professionalDevelopment: null,
				workExperience: null,
				attendedConferences: null,
				participationScienceProjects: null,
				publications: null,
				trainingAids: null,
				contactEmail: null,
				contactPhone: null
    ...
    methods: {
        store() {
			this.formDetailInfo.post(route('admin.userDetail.store'))
		},
    },
