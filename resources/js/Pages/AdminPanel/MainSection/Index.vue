<template>
	<AdminLayout>
		<AdminIndexLayout>
			<AdminIndexHeader>
				<AdminIndexHeaderTitle :title="'Все главные разделы'"/>
				<AdminIndexSearch/>
				<AdminIndexFilter/>
			</AdminIndexHeader>
			<AdminIndexTable>
				...
				<AdminIndexTableBody>
					<template v-for="mainSection in mainSections.data">
						<tr>
							...
							<AdminIndexTableButtonGroup>
								<AdminIndexTableDropdownButton :title="'Действия'">
									<AdminIndexTableDropdownElement :title="'Обновить'" :link="route('admin.mainSection.edit', mainSection.id)" :method="'get'" />
									<AdminIndexTableDropdownElement :title="'Удалить'" :link="route('admin.mainSection.destroy', mainSection.id)" :method="'delete'" />
			...
			<AdminIndexFooter>
				<AdminIndexSelectPerPage :item-length="this.mainSections.data.length" />
				<AdminIndexPaginate :links="this.mainSections.links"/>
			</AdminIndexFooter>
		</AdminIndexLayout>
	</AdminLayout>
</template>
