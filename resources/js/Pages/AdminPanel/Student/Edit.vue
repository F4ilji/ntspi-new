<template>
	<AdminLayout>
		<AdminFormLayout>
			<AdminFormHeader :title="'Обновить студента'" />
			<form @submit.prevent="update">
				...
				<AdminFormButton v-bind="$attrs" type="submit" :title="'Обновить информацию'" />
...
export default {
    ...
    data() {
        return {
			formStudent: this.$inertia.form({
				...
				vk_link: this.student.vk_link,
				contactEmail: this.student.contactEmail,
    ...
    methods: {
        update() {
			this.formStudent.post(route('admin.student.update', this.student.id))
		},
    },
