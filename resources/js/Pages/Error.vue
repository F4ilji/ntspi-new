...
export default {
	...
	computed: {
		...
		description() {
			return {
				503: 'Мы проводим технические работы, вернитесь пожалуйста позже!',
				500: 'Не расстраивайтесь, скоро мы исправим эту ошибку!',
				404: 'Кажется страница не найдена',
				403: 'А вам сюда нельзя',
			}[this.status]
		},
	},
}
